...
<h3 class="panel-title"> Create Account</h3></div>
	<form action="" method="post">
		
			<div style="position:relative;left:10px">
			<b>	Account Name:</b><br>
				<input type="text" name="username" placeholder=" 6 to 30 Characters " style="width:550px">
			<br></br>
			
				<b>Password:</b><br>
				<input type="password" name="password" placeholder=" 8 to 50 Characters " style="width:550px">
			<br></br>
			
			<b>	Password again:</b><br>
				<input type="password" name="password_again" placeholder=" Repeat Your Password " style="width:550px">
			<br></br>
			
			<b>	Email:</b><br>
				<input type="text" name="email" placeholder=" 6 to 255 Characters " style="width:550px">
			<br></br>
			
			<b>	Country:</b><br>
				<select name="flag" style="width:550px">
			...
			?>
				...
				Do you agree to follow the server rules?<br></br>
				<select name="selected" style="width:550px">
