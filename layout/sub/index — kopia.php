...
<div class="head">Server Info</div>
    <p>&emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;&emsp; &emsp; &emsp; &emsp; Server Information</p>
        ...
        <p>
            &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;  The best player is:
                ...
                </a> level: <strong><?php echo $data['bestPlayer']['level']; ?> </strong> congratulations!<br>
			<center>	<?php
            ...
            echo '<img style="margin-top: -35px; margin-left: -35px;" src="https://lepiigortv.com/animatedoutfits/animoutfit.php?id='.$player['looktype'].'&addons='.$player['lookaddons'].'&head='.$player['lookhead'].'&body='.$player['lookbody'].'&legs='.$player['looklegs'].'&feet='.$player['lookfeet'].'&g=0&h=3&i=1"></img>';
           $count++;
            }
            }
            ?></center>
        ...
        <p>
        &emsp; &emsp;&emsp; &emsp; &emsp; &emsp; &emsp; &emsp;&emsp; &emsp;  We have <b><?php echo $data['accountCount']; ?></b> accounts in our database, <b><?php echo $data['playerCount']; ?></b> players, and <b><?php echo $data['guildCount']; ?></b> guilds 
        </p>
