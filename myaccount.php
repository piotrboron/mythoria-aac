...
<h3 class="panel-title"> My Account</h3></div>
<center>
		
		Welcome to your account page, <font color="blue"><strong><?php if ($config['ServerEngine'] !== 'OTHIRE') echo $user_data['name']; else echo $user_data['id']; ?></font></strong><br>
			<div class="inner">
		<?php if ($config['ServerEngine'] !== 'OTHIRE') {
				if ($user_data['premdays'] != 0) {
					echo 'You have <font color="green">' .$user_data['premdays']. ' </font>remaining premium account days.';
				} else {
			...
			?>
			<center><h4 style="color:blue"> Admin Panel </h4></center>
			<hr>
			...
			<a href="admin_news.php" class="btn btn-primary btn-shiny btn-block">
				...
				<a href="changelog.php" class="btn btn-primary btn-shiny btn-block">
				<font color="orange">Admin Changelog</font></a>
		...
		</div><table style="position:relative;left:245px"><td>
		<a href="buypoints.php" class="btn btn-primary btn-shiny btn-block" style="width:150px">
				Donate</a></td>
				</table><br></br>
			<div class="news">
<div class="clearfix"></div>
<div class="panel panel-default">
<div class="panel-heading">
<h3 class="panel-title"> Account Information</h3></div>
<table style="width:100%">
	<td>Email:</td><td><?php echo $user_data['email']; ?></td><tr>
	<td>Account:</td><td><?php if ($config['ServerEngine'] !== 'OTHIRE') echo $user_data['name']; else echo $user_data['id']; ?></td><tr>
	<td>Password:</td><td>*******</td><td>
		...
		<td>	<a href="createcharacter.php" class="btn btn-primary btn-shiny btn-block" style="width:150px">
				Create Character</a>

			<td><a href="changepassword.php" class="btn btn-primary btn-shiny btn-block" style="width:150px">
				Change Password</a>

		<td>	<a href="settings.php" class="btn btn-primary btn-shiny btn-block" style="width:150px">
			Settings</a>
			<td>
			<a href="logout.php" class="btn btn-primary btn-shiny btn-block" style="width:150px">
			Logout</a>
		</center>
		</table>
...
<div class="panel panel-default">
<div class="panel-heading">
<h3 class="panel-title"> Character List, <?php echo $char_count; ?> Characters</h3></div>
