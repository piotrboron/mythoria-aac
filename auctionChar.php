...
<h3 class="panel-title"> Character Auction</h3></div>
<?php
// Import from config:
...
if ($auction['characterAuction']) {
		...
		if ($zaid !== false) {
			...
			if (is_array($character) && !empty($character)) {
				...
				<table class="auction_skills">
					...
					<tr><td><img src="images/ml.gif" style="width:35px"></td><td>magic</td><td><?php echo $character['magic']; ?></td></tr>
					<tr><td><img src="images/fist.gif" style="width:35px"></td><td>fist</td><td><?php echo $character['fist']; ?></td></tr>
					<tr><td><img src="images/club.gif" style="width:35px"></td><td>club</td><td><?php echo $character['club']; ?></td></tr>
					<tr><td><img src="images/sword.gif" style="width:35px"></td><td>sword</td><td><?php echo $character['sword']; ?></td></tr>
					<tr><td><img src="images/axe.gif" style="width:35px"></td><td>axe</td><td><?php echo $character['axe']; ?></td></tr>
					<tr><td><img src="images/dist.gif" style="width:35px"></td><td>dist</td><td><?php echo $character['dist']; ?></td></tr>
					<tr><td><img src="images/def.gif" style="width:35px"></td><td>shielding</td><td><?php echo $character['shielding']; ?></td></tr>
					<tr><td><img src="images/fish.gif" style="width:35px"></td><td>fishing</td><td><?php echo $character['fishing']; ?></td></tr>
				</table></div></div>
				<?php
	...
	if ($action === 'list') {
		...
		?>
		<p><a href="/auctionChar.php?action=create">Add a character to the auction</a>.</p></div></div>
		<?php
