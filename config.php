<?php
	...
	$config['server_path'] = 'your server path example C:/documents/server/';
	...
	$config['sqlUser'] = 'secret';

	// phpmyadmin password for OT server:
	$config['sqlPassword'] = 'secret!';

	// The database name to connect to. (This is usually same as username).
	$config['sqlDatabase'] = 'secret';
	...
	*/
	...
	$config['show_outfits'] = array(
		...
		'imageServer' => 'https://outfit-images.ots.me/1099_walk_animation/animoutfit.php'
	);
	...
	$config['gameserver'] = array(
		'ip' => '127.0.0.1',
		'port' => 7172,
		'name' => 'Mythoria' // Must be identical to config.lua (OT config file) server name.
	);
	...
	*/
	...
	$config['captcha_site_key'] = "6LebIOspAAAAAAS_Iz_Qgb6Hk2_bliRPBq7MqyTs";
	$config['captcha_secret_key'] = "6LebIOspAAAAANAK8r8PIq8RpuWJXiUyEge-34gU";
	...
	*/
	...
	$config['paypal'] = array(
		'enabled' => true, // IF ENABLED and you are using UniserverZ, make sure on core/php74 on php_production you have enable ;extension= CURL, just remove the ; before 
	...
	*/
	$config['shop_offers'] = array(
		...
		7 => array(
			'type' => 5,
			'itemid' => [136, 128], // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Citizen outfit with both addons",
			'points' => 20,
		),
		8 => array(
			'type' => 6,
